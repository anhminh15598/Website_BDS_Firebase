const ptBR = {
  ...
  entities: {
    ...
    staff: {
      ...
      fields: {
        ...
        staffIsAServiceWorker:
          'Nhân viên là một nhân viên phục vụ',
        ...
        staffAccessApps:
          'Cho phép truy cập vào ứng dụng di động',
        createdAt: 'Tạo vào lúc',
        updatedAt: 'Cập nhật vào lúc',
        createdAtRange: 'Tạo vào lúc',
      },
    ...
    taxClass: {
      ...
      importer: {
        title: 'Import doanh số',
        fileName: 'doanhSo_import_template',
        hint: 'Import Doanh số.',
      },
    },
  ...
  auth: {
    ...
    signup: 'Đăng ký',
    signout: 'Đăng xuất',
    alreadyHaveAnAccount: 'Quay lại trang đăng nhập',
    ...
    verifyEmail: {
      ...
      message: 'Email của bạn đang được xác minh ...',
    },
  },
  ...
  user: {
    ...
    validations: {
      ...
      email:
        'Thiếu @ ví dụ: ${value}@gmail.com, ${value}@hotmail.com,... ',
    },
  },
