const en = {
  ...
  entities: {
    ...
    staff: {
      ...
      label: 'Staffs',
      menu: 'Staffs',
      exporterFileName: 'nhansu_export',
      list: {
        menu: 'Staffs',
        title: 'Staffs',
      },
    ...
    units: {
      ...
      label: 'Phòng ban',
      menu: 'Phòng ban',
      exporterFileName: 'Donh số phòng ban',
      list: {
        menu: 'Phòng ban',
        title: 'Phòng ban',
      },
      create: {
        success: 'Phòng ban được thêm thành công',
      },
      update: {
    ...
    allowanceAndDeduction: {
      ...
      create: {
        success:
          'Allowance And Deduction saved successfully',
      },
      update: {
        success:
          'Allowance And Deduction saved successfully',
      ...
      destroy: {
        success:
          'Allowance And Deduction deleted successfully',
      },
      destroyAll: {
        success:
          'Allowance And Deduction(s) deleted successfully',
      },
      edit: {
  ...
  roles: {
    ...
    allowanceAndDeductionEditor: {
      ...
      description:
        'Edit access to Allowances And Deductions',
    },
    allowanceAndDeductionViewer: {
      label: 'Allowance And Deduction Viewer',
      description:
        'View access to Allowances And Deductions',
    },
    payrollEditor: {
