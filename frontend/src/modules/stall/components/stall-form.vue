  ...
  <div>
    ...
    >
      ...
      <el-form-item
        ...
        :required="fields.teamName.required"
      >
        <el-col :lg="11" :md="16" :sm="24">
          <el-input v-model="model[fields.teamName.name]" />
        </el-col>
      </el-form-item>
      ...
      >
        <el-col :lg="11" :md="16" :sm="24">
          <el-input-number
            :precision="fields.stallLoyaltyPointValue.scale"
            :step="0.1"
            v-model="model[fields.stallLoyaltyPointValue.name]"
          ></el-input-number>
        </el-col>
      </el-form-item>
