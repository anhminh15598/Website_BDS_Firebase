...
function enumeratorLabel(name, value) {
  return i18n(
    `entities.units.enumerators.${name}.${value}`,
  );
}
...
const fields = {
  ...
  productStall: StallField.relationToMany(
    'productStall',
    label('productStall'),
    {
      // required: true,
  ...
  unitsType: new EnumeratorField(
    'unitsType',
    label('unitsType'),
    [
      {
        id: 'decimal',
        label: enumeratorLabel('unitsType', 'decimal'),
      },
      {
        id: 'integer',
        label: enumeratorLabel('unitsType', 'integer'),
      },
      {
        id: 'none',
        label: enumeratorLabel('unitsType', 'none'),
      },
    ],
    {
      required: true,
